...
export const TableILS = (ilsLong: boolean) => {
                ...
                <TableCell>
                    ...
                    >
                        <FormControlLabel value={stepsLongILS[activeStep].questionNumber1} control={<Radio/>}
                                          label={<Typography
                                              variant={"h6"}>{t(stepsLongILS[activeStep].answer1_1)}</Typography>}/>
                        <FormControlLabel value={stepsLongILS[activeStep].answer1_2} control={<Radio/>}
                                          label={<Typography
                                              variant={"h6"}>{t(stepsLongILS[activeStep].answer1_2)}</Typography>}/>
                    </RadioGroup>
                </TableCell>
            </TableRow>
            <TableRow>
                    ...
                    <StyledMobileStepper
                        ...
                        nextButton={
                            <Button variant="contained"
                                    ...
                                    disabled={ilsLong ? activeStep === 10 : activeStep === 4}>
                                Next
                                {theme.direction === 'rtl' ? (
                                    <KeyboardArrowLeft/>
                                ) : (
